...
st.write("Книжный клуб «Читаем вместе» (г. Алматы). Существует с июля 2014 года.")
st.write("Обсуждения книг - 1 раз в месяц.")
st.write("Присоединяйтесь! Будем читать вместе.")
